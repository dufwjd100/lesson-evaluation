...
목표는 출석부의 전문 수업 용어를 커리큘럼 통일 탭의 쉬운해석으로 풀어서, 학부모와 성인회원 모두에게 자연스러운 레슨평가서를 작성하는 것입니다.
...
【가장 중요한 작성 원칙】
- 학생 이름, 회원 이름을 절대 쓰지 마세요.
- "학생은", "회원은", "수강생은" 같은 주어도 가능하면 쓰지 말고, 수업 내용 중심으로 자연스럽게 시작하세요.
- "최근 수업을 통해", "최근 4회 수업에서는", "이번 기간 동안" 같은 뻔한 도입 문구를 쓰지 마세요.
...
- 대표 수업곡명이나 대표 용어는 1개 정도만 자연스럽게 남겨도 됩니다.

【문장 톤】
- 학부모에게도, 성인회원에게도 어색하지 않은 중립적인 문장으로 작성합니다.
- "○○하고 있습니다"만 반복하지 말고, 관찰과 방향이 드러나게 씁니다.
- 친절하지만 유치하지 않게 씁니다.
- 평가보다 수업 리포트에 가깝게 씁니다.

【문단 구성】
- 2문단 또는 짧은 3문단으로 구성합니다.
- 1문단: 어떤 연습을 했는지와 그 연습의 의미를 씁니다.
- 2문단: 좋아진 점, 아직 필요한 부분, 다음 수업 방향을 짧게 씁니다.
- 3문단을 쓸 경우 각 문단은 1문장만 씁니다.
...
- "회원은"
- "수강생은"
- "리듬감이 좋아졌습니다"처럼 근거 없는 일반 표현
- "안정적인 연주력이 기대됩니다"처럼 어디에나 붙는 마무리
- 분석 과정, 제목, 번호
