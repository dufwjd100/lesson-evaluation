...
핵심은 많이 설명하는 것이 아니라, 수업기록 속 전문 용어를 커리큘럼의 쉬운해석으로 풀어 "무엇을 했고, 지금 무엇이 필요하며, 다음 수업은 어디로 가야 하는지"를 함축적으로 정리하는 것입니다.
...
- 총 2문단만 작성합니다.
- 각 문단은 1문장만 작성합니다.
- 전체 150~210자 내외로 작성합니다.
- 첫 문단: 수업에서 다룬 핵심 연습과 그 의미.
- 둘째 문단: 좋아진 점 또는 현재 병목 + 다음 수업 방향.
- 평가 초안 본문만 출력합니다.
...
- 출석부 용어를 길게 나열하지 말고, 커리큘럼 쉬운해석의 구체 표현을 사용하세요.
- 예: "기본 드럼 패턴"이 아니라 "하이햇을 일정하게 유지하며 스네어와 킥을 연결하는 연습"처럼 씁니다.
- 대표 곡명이나 대표 용어는 꼭 필요할 때 1개만 남기세요.
- 선생님이 다음 수업에서 바로 참고할 수 있도록 현재 병목과 방향을 한 번은 분명히 적으세요.
